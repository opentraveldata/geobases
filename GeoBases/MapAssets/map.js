...
function initialize(jsonData) {
    ...
    $('#info').html('{0} <i>point(s) on map</i> (out of {1}), {2} <i>line(s)</i>, {3} color(s) for <i>{4}</i>, circle size: <i>{5}</i> (max {6})'.fmt(markersArray.length, n, jsonData.lines.length, jsonData.categories.length, icon_color, icon_weight, max_value));
